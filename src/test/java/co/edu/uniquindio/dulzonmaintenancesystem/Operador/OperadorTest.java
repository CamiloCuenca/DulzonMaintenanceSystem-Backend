...
import co.edu.uniquindio.dulzonmaintenancesystem.dto.DtoEditarCartaGantt;
...
public class OperadorTest {
    ...
    public void editarCartaGantt() {
        ...
        DtoEditarCartaGantt cartaGanttDTO = new DtoEditarCartaGantt(actividades, cuadrillas, "ProyectPrueba1");
        servicioOperadorImp.editarCartaGantt(cartaGanttDTO);
